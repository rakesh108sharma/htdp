...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname p9) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; number number number number -> number
;; produces the distance between 2 points
; BETTER: produce cartesian distance between (x1, y1) and (x2, y2)
